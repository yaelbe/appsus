!(function (e, t) {
  ...
  function V(t, n, r) {
    ...
    n = n || new FormData()
    var o = (r = I.toFlatObject(r, { metaTokens: !0, dots: !1, indexes: !1 }, !1, function (e, t) {
  ...
  var Y,
    ...
    ne = {
      ...
      isStandardBrowserEnv:
        ('undefined' == typeof navigator || ('ReactNative' !== (Y = navigator.product) && 'NativeScript' !== Y && 'NS' !== Y)) &&
      ...
      function (e, t) {
        ...
        if (i) {
          ...
          if ((n = I.isFileList(e)) || r.indexOf('multipart/form-data') > -1) {
            ...
            return V(n ? { 'files[]': e } : e, a && new a(), this.formSerializer)
          }
        }
        return i || o
            ...
            value: function (e, t, n) {
              ...
              return (
                I.isPlainObject(e) || e instanceof this.constructor
                  ? f(e, t)
                  : I.isString(e) && (e = e.trim()) && !/^[-_a-zA-Z]+$/.test(e.trim())
                  ? f(
                      ((c = {}),
                      (i = e) &&
                        i.split('\n').forEach(function (e) {
            ...
            if (u) {
              ...
              !(function (e, t, n) {
                ...
                n.status && r && !r(n.status)
                  ? t(new q('Request failed with status code ' + n.status, [q.ERR_BAD_REQUEST, q.ERR_BAD_RESPONSE][Math.floor(n.status / 100) - 4], n.config, n.request, n))
                  : e(n)
              })(
                function (e) {
                  t(e), s()
  ...
  function Re(e) {
    return (
      ...
      Oe(e.adapter || ae.adapter)(e).then(
        ...
        function (t) {
          return (
            me(t) || (Se(e), t && t.response && ((t.response.data = he.call(e, e.transformResponse, t.response)), (t.response.headers = pe.from(t.response.headers)))),
            Promise.reject(t)
          )
        }
      )
  ...
  function Te(e, t) {
    ...
    var n = {}
    function r(e, t, n) {
      return I.isPlainObject(e) && I.isPlainObject(t) ? I.merge.call({ caseless: n }, e, t) : I.isPlainObject(t) ? I.merge({}, t) : I.isArray(t) ? t.slice() : t
    }
    function o(e, t, n) {
  ...
  var Ce = {
    ...
    ke = (function () {
      function e(n) {
        t(this, e), (this.defaults = n), (this.interceptors = { request: new ee(), response: new ee() })
      }
      return (
        r(e, [
          {
            ...
            value: function (e, t) {
              ...
              void 0 !== o &&
                ...
                void 0 !== i && Ce.assertOptions(i, { encode: Pe.function, serialize: Pe.function }, !0),
